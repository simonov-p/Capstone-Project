...
public class GameInfoLeadersFragment extends Fragment {
    ...
    public void fillViews(Game game) {
        ...
        mAwayFGP.setText(String.valueOf(awayPlayer.field_goal_percentage));
        mAway3PP.setText(String.valueOf(awayPlayer.three_point_percentage));
        mAwayTO.setText(String.valueOf(awayPlayer.turnovers));
        mAwayPlayerMinutes.setText(String.valueOf(awayPlayer.minutes));
        mAwayPlayerFG.setText(String.format("%d/%d", awayPlayer.field_goals_made, awayPlayer.field_goals_attempted));
        mAwayPlayer3P.setText(String.format("%d/%d", awayPlayer.three_point_field_made, awayPlayer.three_point_field_attempted));
        mAwayPlayerFT.setText(String.format("%d/%d", awayPlayer.free_throws_made, awayPlayer.free_throws_attempted));
        mAwayPlayerFTP.setText(String.valueOf(awayPlayer.free_point_percentage));
        ...
        mAwayPlayerFouls.setText(String.valueOf(awayPlayer.personal_fauls));
        ...
        mHomeFGP.setText(String.valueOf(homePlayer.field_goal_percentage));
        mHome3PP.setText(String.valueOf(homePlayer.three_point_percentage));
        mHomeTO.setText(String.valueOf(homePlayer.turnovers));
        mHomePlayerMinutes.setText(String.valueOf(homePlayer.minutes));
        mHomePlayerFG.setText(String.format("%d/%d", homePlayer.field_goals_made, homePlayer.field_goals_attempted));
        mHomePlayer3P.setText(String.format("%d/%d", homePlayer.three_point_field_made, homePlayer.three_point_field_attempted));
        mHomePlayerFT.setText(String.format("%d/%d", homePlayer.free_throws_made,homePlayer.free_throws_attempted));
        mHomePlayerFTP.setText(String.valueOf(homePlayer.free_point_percentage));
        ...
        mHomePlayerFouls.setText(String.valueOf(homePlayer.personal_fauls));
